...
# environment
env = irsim.make(save_ani=True, display=True, full=False)
...
env.draw_trajectory(ref_path_list, traj_type='-k') # plot path, ref_path_list: list of np.array, shape=(591, 3)
